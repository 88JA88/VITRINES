...
window.RECHERCHE = {
  ...
  "OBJ-0004": {
    ...
    "particularites": "Plaque semi-circulaire en alliage cuivreux, épaisse et légèrement bombée, ornée de plusieurs ocelles ou cercles concentriques pointés régulièrement répartis sur la face. Le revers comporte des éléments saillants de fixation, dont une patte perforée, compatibles avec un système d’articulation ou de montage sur une ceinture ou une courroie.",
    "nature": [
      "Parures vestimentaires"
    ],
    "epoque": [
  ...
  "OBJ-0005": {
    ...
    "particularites": "Disque circulaire muni de plusieurs appendices périphériques. La face est organisée en cercles concentriques autour d’une bosse centrale très saillante. Des restes d’émail bleu et des traces rouges et claires sont visibles. Le revers conserve des reliefs compatibles avec l’ancien système de fixation.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0006": {
    ...
    "particularites": "Petite fibule-plaque symétrique à partie centrale rectangulaire. Le décor géométrique est composé de compartiments triangulaires avec des restes d’émail. De part et d’autre, des prolongements moulurés se terminent par des appendices arrondis. Le système d’attache au revers est incomplet.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0007": {
    ...
    "particularites": "Petite fibule-plaque symétrique autour d’une plaque centrale rectangulaire légèrement bombée. La face porte un décor compartimenté avec des restes d’émail rouge et verdâtre. Les extrémités latérales sont moulurées et symétriques. Le système d’attache au revers est incomplet.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0008": {
    ...
    "particularites": "Petite fibule-plaque allongée centrée sur une plaque rectangulaire. La face présente une rangée de motifs en losange ou étoilés avec des restes d’émail clair et rouge. Le décor est encadré par des moulures longitudinales. Le système d’attache au revers est incomplet.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0011": {
    ...
    "particularites": "Fibule allongée et fortement arquée. La face porte plusieurs excroissances ou disques ornés d’ocelles, formés de petits cercles concentriques avec point central. Le corps est étroit et longitudinal et le profil présente une courbure très marquée. Le revers conserve des éléments du dispositif d’attache.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0012": {
    ...
    "particularites": "Petite fibule zoomorphe dont la silhouette évoque une tortue stylisée. Une extrémité forme une tête avec museau, tandis que le corps central massif, encadré de fortes moulures transversales, peut être interprété comme une carapace. Le revers est épais et arqué et conserve des vestiges du système de fixation.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0014": {
    ...
    "particularites": "Fibule en forme d’oiseau à silhouette très lisible : tête relevée, bec fortement recourbé, œil circulaire marqué et corps compact. L’aile est soulignée par un décor incisé ou moulé. Le revers conserve le dispositif de broche, avec ardillon et éléments de fixation.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0015": {
    ...
    "particularites": "Deux petites pièces de dimensions très proches figurant chacune une tête de canard stylisée. La tête, le bec et le profil d’oiseau sont nettement lisibles. Chaque pièce présente une protubérance verticale près de la tête ainsi que des éléments de construction au revers, probablement liés à un système de liaison ou d’articulation.",
    "nature": [
      "Parures vestimentaires"
    ],
    "epoque": [
  ...
  "OBJ-0016": {
    ...
    "particularites": "Deux pièces presque identiques, longues d’environ 4 à 4,2 cm. Chaque élément possède un corps allongé légèrement courbe et une extrémité élargie figurant nettement une tête canine. Des lignes incisées soulignent la tête et le corps de l’animal.",
    "nature": [
      "Parures vestimentaires"
    ],
    "epoque": [
  ...
  "OBJ-0019": {
    ...
    "particularites": "Petite fibule aviforme en alliage cuivreux, au corps allongé et fuselé et à la queue pointue. Un petit éclat métallique doré subsiste sur la surface, compatible avec une dorure ancienne presque entièrement disparue. Le revers conserve les vestiges du système d’attache. La lecture actuelle privilégie un oiseau terrestre, probablement une perdrix.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0021": {
    ...
    "particularites": "Grand pendentif en forme de croissant ou lunule, couvert de nombreux petits cercles pointés ou ocelles. Une bélière tubulaire très visible occupe la partie supérieure. Les deux extrémités inférieures sont allongées ; l’une conserve un petit ajour. Le revers est plat et présente plusieurs petits orifices.",
    "nature": [
      "Parures vestimentaires"
    ],
    "epoque": [
  ...
  "OBJ-0022": {
    ...
    "particularites": "Antoninien au flan irrégulier. À l’avers, Gallien est représenté radié et cuirassé à droite ; la légende IMP C P LIC GALLIENVS P F AVG est largement lisible. Le revers porte la légende LIBERALITAS AVGG et semble représenter Valérien Ier et Gallien assis, avec le jeune Valérien II entre eux.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0023": {
    "designation": "Denier d’Antonin le Pieux, type Salus",
    "particularites": "Denier au flan légèrement irrégulier. À l’avers, tête laurée d’Antonin le Pieux tournée à droite, avec la légende ANTONINVS AVG PIVS P P IMP II. Au revers, Salus est assise à gauche et tend une patère vers un serpent enroulé autour d’un autel. Quelques dépôts et traces verdâtres sont visibles.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0024": {
    ...
    "particularites": "Petit bronze au flan irrégulier. Une face montre une tête double ou janiforme compatible avec Janus. L’autre, beaucoup plus usée, présente un motif interprétable comme une proue de navire. Le diamètre de 19 mm est relativement faible pour de nombreux asses républicains.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0025": {
    "designation": "Bronze d’Antiochos Ier de Commagène, aigle",
    "particularites": "Petit bronze de 16 mm présentant à l’avers la tête d’Antiochos Ier tournée à droite, coiffée d’une haute tiare royale. Le revers montre un aigle debout à droite et porte la légende grecque ΒΑΣΙΛΕΩΣ ΑΝΤΙΟΧΟΥ, « du roi Antiochos ». La surface est usée mais les principaux éléments du type restent lisibles.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0026": {
    ...
    "particularites": "Bronze provincial romain très usé. L’avers montre une tête masculine laurée tournée à droite, compatible avec Hadrien. Au revers, le relief central conserve la silhouette d’un quadrupède interprété comme un cerf.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0027": {
    ...
    "particularites": "Fibule en alliage cuivreux à arc fortement cintré, presque semi-circulaire. La tête conserve une charnière et l’ardillon articulé. Le pied se prolonge par un porte-ardillon plein et développé. La pièce paraît globalement complète.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0029": {
    ...
    "particularites": "Fibule romaine longue et étroite, à arc légèrement cintré. La tête roulée en tube forme la charnière. Trois moulures transversales marquent la partie haute de l’arc et un discret décor longitudinal est visible sur le corps. Le pied et une partie du porte-ardillon sont conservés ; l’axe et l’ardillon manquent.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0031": {
    ...
    "particularites": "Petit denier sur flan mince, irrégulier et légèrement ondulé. La morphologie et les éléments lisibles correspondent très probablement à un denier carolingien de Charlemagne frappé à Dorestad.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0032": {
    ...
    "particularites": "Petit denier anonyme en billon, frappé sur un flan irrégulier. Le type associe une grande croix, quatre annelets et les légendes dégénérées RAMVNDS / NAIDONA. Le poids n’a pas été mesuré.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0033": {
    ...
    "particularites": "Deux éléments creux et fragmentaires à corps bombé ou globulaire, col court et extrémité discoïde. Les grandes ouvertures visibles correspondent à des cassures. Des saillies internes régulières peuvent correspondre à des pattes ou ergots de fixation. L’extrémité centrale est pleine et ne présente pas de trou de suspension.",
    "nature": [
      "Garnitures",
  ...
  "OBJ-0034": {
    ...
    "particularites": "Bague massive à anneau épais et épaules fortement élargies et carénées. Le chaton plat, ovale à presque circulaire, est gravé d’un motif végétal stylisé évoquant une palmette, une branche ou une feuille nervurée. Les épaules portent des chevrons et des traits incisés.",
    "nature": [
      "Bagues",
      "Bijoux"
    ],
  ...
  "OBJ-0035": {
    ...
    "particularites": "Petit bronze fortement corrodé. Une face présente une tête humaine de profil compatible avec Apollon portant une taenia. L’autre montre assez nettement un jeune cavalier à cheval. La légende et les éventuels symboles de contrôle ne sont plus lisibles.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0036": {
    ...
    "particularites": "Petit instrument en alliage cuivreux comportant un cuilleron ovale et peu profond de 20 x 15 mm. Le manche est cassé ; un épaulement net à la jonction montre qu’il se prolongeait par une tige plus fine.",
    "nature": [
      "Objets de toilette"
    ],
    "epoque": [
  ...
  "OBJ-0038": {
    ...
    "particularites": "Applique discoïde en alliage cuivreux à décor concentrique émaillé. La face est divisée en plusieurs registres circulaires séparés par des nervures métalliques ; des vestiges d’émail rouge-orangé et sombre subsistent dans les cellules. Le revers est plat et porte au centre un tenon de fixation.",
    "nature": [
  ...
  "OBJ-0040": {
    ...
    "particularites": "Anneau de harnais à grand passage circulaire, prolongé à la base par une fixation intégrée formant une ouverture longitudinale et un terminal évasé. Le dispositif de fixation est nettement plus développé que sur un simple anneau de terret.",
    "nature": [
      "Harnachement"
    ],
    "epoque": [
  ...
  "OBJ-0042": {
    "designation": "Fibule romaine fortement profilée, type Almgren 70/73 probable",
    "particularites": "Grande fibule romaine fortement profilée, à arc puissant et fortement cambré. Une importante moulure annulaire marque la transition vers un long pied effilé terminé par un bouton relevé. Le porte-ardillon est développé et l’ardillon est largement conservé.",
    "nature": [
      "Fibules"
    ],
    "epoque": [
  ...
  "OBJ-0043": {
    "designation": "Boucle composite médiévale à entretoise fourchue intégrée",
    "particularites": "Grande boucle composite en alliage cuivreux à cadre ovale. Le cadre se prolonge directement par deux longues branches parallèles constituant une entretoise fourchue intégrée. L’ardillon, long et légèrement courbe, est conservé. Les plaques qui enserraient à l’origine l’entretoise et maintenaient l’extrémité de la courroie ont disparu.",
    "nature": [
      "Parures vestimentaires"
    ],
    "epoque": [
  ...
  "OBJ-0045": {
    ...
    "particularites": "Anneau de pouce massif en alliage cuivreux, de 22 mm de diamètre intérieur, prolongé sur la face externe par une large palette triangulaire. Celle-ci porte un décor entièrement non figuratif composé de lignes incisées, de faisceaux de hachures obliques, de chevrons et d’un petit motif central étoilé ou en rosette rayonnante. Le décor se prolonge sur les côtés de la palette. L’anneau est large, épais et légèrement asymétrique. Une petite protubérance extérieure est présente à l’arrière de l’anneau ; elle paraît appartenir à la construction d’origine et avoir eu un rôle fonctionnel dans le maintien ou le positionnement de l’anneau sur le pouce.",
    "nature": [
      "Bagues",
      "Objets militaires"
    ],
  ...
  "OBJ-0046": {
    "designation": "Bracelet ouvert protohistorique en alliage cuivreux à extrémités aplaties",
    "particularites": "Bracelet ouvert à jonc massif, circulaire à subcirculaire, sans décor visible. Le jonc atteint environ 7 mm dans sa partie la plus épaisse puis s’amincit progressivement jusqu’à environ 5 mm vers les deux extrémités. Celles-ci sont légèrement élargies et aplaties, sans motif figuratif ni traitement zoomorphe.",
    "nature": [
      "Bijoux"
    ],
    "epoque": [
  ...
  "OBJ-0048": {
    ...
    "particularites": "Bracelet en verre vert translucide portant sur sa face extérieure une série de pastilles ovales brun-rouge régulièrement espacées et appliquées à chaud. Anneau incomplet. Altération superficielle du verre. Attribution à la période islamique médiévale probable, sans provenance géographique attestée.",
    "nature": [
      "Bijoux"
    ],
    "epoque": [
