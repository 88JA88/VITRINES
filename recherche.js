...
window.RECHERCHE = {
  ...
  "OBJ-0023": {
    ...
    "particularites": "Denier d’Antonin le Pieux au flan irrégulier. À l’avers, tête laurée de l’empereur tournée à droite ; la légende ANTONINVS AVG PIVS P P IMP II est partiellement lisible. Au revers, Salus est assise à gauche et nourrit, à l’aide d’une patère, un serpent enroulé autour d’un autel. La légende TR POT XX COS IIII permet d’orienter l’identification vers le type RIC III 264, frappé à Rome en 156–157. Quelques dépôts et traces verdâtres sont visibles ; l’authenticité ne peut pas être certifiée sur photographies seules.\n\nUSAGE -\nLe denier était une monnaie d’argent de circulation dans l’Empire romain. Le portrait impérial et les légendes identifiaient l’autorité émettrice ; le revers à Salus associait l’émission à la santé, à la sauvegarde et à la prospérité de l’empereur et de l’État.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
  ...
  "OBJ-0025": {
    ...
    "particularites": "Petit bronze de 16 mm présentant à l’avers la tête d’Antiochos Ier tournée à droite, coiffée d’une haute tiare royale. Le revers montre un aigle debout à droite. La légende grecque ΒΑΣΙΛΕΩΣ ΑΝΤΙΟΧΟΥ signifie « du roi Antiochos ». L’ensemble correspond très probablement au type RPC I 3847 / Kovacs 226, attribué au royaume de Commagène. La surface est usée mais les éléments caractéristiques du type restent lisibles.\n\nUSAGE -\nMonnaie de circulation du royaume de Commagène. Comme de nombreux bronzes hellénistiques, elle associait une fonction économique à l’affirmation de l’autorité royale : le portrait du souverain et la légende grecque rendaient le pouvoir d’Antiochos immédiatement identifiable.",
    "nature": [
      "Monnaies"
    ],
    "epoque": [
